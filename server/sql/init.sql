db.collection.drop('todo')
db.collection.drop('user')
db.collection.drop('token')
db.collection.drop('blog')
db.collection.drop('tag')
db.collection.drop('keyword')
db.collection.drop('lostcity')
db.collection.drop('basedata')
db.collection.drop('file')
db.collection.drop('album')
db.collection.drop('photo')
